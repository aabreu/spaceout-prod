...
urlpatterns = [
    ...
    url(r'^api/accounts/change/spacername/$', views.ChangeSpacerNameView.as_view(), name='change_spacer_name'),
    url(r'^api/accounts/change/email/$', views.ChangeEmailView.as_view(), name='change_email'),
