...
class SpaceoutUserAdmin(EmailUserAdmin):
    fieldsets = (
        ...
        ('SpaceoutVR', {'fields': ('featured', 'last_activity', 'phone_number', 'latitude', 'longitude', 'notification_id', 'facebook_id', 'twitter_id', 'soundcloud_id', 'reddit_id', 'fb_gender', 'fb_birthdate', 'fb_location', 'personality_insights_input_url', 'personality_insights_output_url', 'featured_input_url', 'featured_page_url')}),
    )
    model = SpaceoutUser
